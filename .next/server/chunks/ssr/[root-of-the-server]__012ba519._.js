...
;
const metadata = {
    title: "Famcare Health Speciality",
    description: "Famcare Health Speciality in Ayikkarappadi provides compassionate, comprehensive healthcare with advanced diagnostics, pharmacy, and modern treatment facilities.",
    icons: {
        icon: '/favicon.png',
        apple: '/favicon.png'
    }
